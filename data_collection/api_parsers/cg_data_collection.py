# здесь по id переходить не надо, все хранится на главной странице, но всей информации нет на ней, поэтому
# недостающие данные парсятся с помощью selenium в selenium_parsers/get_specs_cg.py
