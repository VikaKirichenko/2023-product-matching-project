...
from utilities import get_products_to_match, get_random_product, predict_products
    ...
    if request.method == 'POST':
        if 'generate' in request.form:
            ...
            try:
                ...
                return render_template('predict_matches.html', error = 'Ошибка ввода информации. Проверьте цену')
